...
func main() {
	...
	//fmt.Println(root.d.v)
	fmt.Println("Busca(true): ", busca(root, 5)) // verifica se o nodo da esquerda é 5
	fmt.Println("Busca(true): ", busca(root, 15)) // verifica se o nodo da esquerda é 5

	//fmt.Println("Busca(false): ", busca(root.e , 10))
	//fmt.Println("Busca(true): ", busca(root.d, 13))
